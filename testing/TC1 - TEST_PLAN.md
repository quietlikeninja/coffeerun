...
| TC-INV-02 | Invite Existing User as Member with Colleague Linking | ❌ | No option to select Alice as the linked member |
...
| ID | Test Case | Result | Notes |
|----|-----------|--------|-------|
| TC-SELF-01 | Member Edits Own Coffee Options | ⬜ | TC-INV-02 user linking isnt working |
...
| Invite Flow | 5 | 4 | 1 | 0 |
| Role-Based Access | 3 | 2 | 1 | 0 |
| Ordering | 4 | 4 | 0 | 0 |
| Visitors | 5 | 5 | 0 | 0 |
| Self-Service Editing | 3 | 2 | 0 | 1 |
| Team Switching | 3 | 0 | 0 | 3 |
| Stats | 2 | 1 | 0 | 1 |
...
|---|-----------|----------|-------------|--------------|
| 1 | TC-INV-02 | High | When inviting a user there is no option to select the existing colleague. Even after the invite is accepted there is no option to link a user to a colleague. | #1 |
| 2 | TC-TOLE-03 | Low | I was able to change the Managers role in the Drop down to Owner but it didn't save or actually change the role in any way. | #2 |
